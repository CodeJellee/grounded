    ...
    products = [
        {
            ...
            "product_preview_image": "link url"
        },
        {
            "sellerId": 1,
        ...
        },
        {
            ...
            "product_price": 32.50,
            "product_description": 'アカサヤネムノキ (Pithecellobium Confertum) is a popular foliage plant from Japan. Interestingly, the leaves close at night to conserve water, known as the "sleep exercise".',
            "product_quantity": 2,
        ...
        },
        {
            ...
            "product_price": 16.75,
            "product_description": "ソフォラ ・ ミクロフィラ (Sophora Prostrata) Imported from Japan.",
            "product_quantity": 6,
